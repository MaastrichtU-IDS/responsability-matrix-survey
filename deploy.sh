...
# Build with cache:
ssh ids3 'cd /data/deploy-services/responsability-matrix-survey ; git pull ; docker-compose -f docker-compose.yml -f docker-compose.prod.yml up --force-recreate --build -d'
