...
const componentExp = <Component, String>{
  ...
  Component.accountability: '(Project -> organization)',
  Component.privacy:
...
const matrixExp = <Scope, Map<Component, String>>{
  Scope.actors: {
    Component.transparency:
        'Identifies the roles, the contributions, and the interests of the involved actors (i.e. principal investigator, developers, end users, organizations).',
  ...
  Scope.impact: {
    Component.transparency:
        'Identifies and describes  the short, and long term impacts (both negative and positive) of the project (i.e. key exploitable results, recognizable possible negative and positive downstream impacts).',
    Component.accountability:
